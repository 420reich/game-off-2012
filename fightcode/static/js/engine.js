...
Rectangle = (function() {
  ...
  Rectangle.prototype.simpleIsContained = function(otherRectangle) {
    var rad;
    rad = this.minRadius;
    if (this.position.x - rad > otherRectangle.upperLeft.x && this.position.x + rad < otherRectangle.lowerRight.x && this.position.y - rad > otherRectangle.upperLeft.y && this.position.y + rad < otherRectangle.lowerRight.y) {
      return true;
    }
    return false;
  };
