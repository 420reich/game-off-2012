...
FightArena = (function() {
  ...
  function FightArena(container) {
    ...
    this.defaultCode = "            window.robotClass = function(){            };            window.robotClass.prototype.onIdle = function(ev) {               var robot = ev.robot;                              robot.rotateCannon(1);               robot.fire();            };            window.robotClass.prototype.onScannedRobot = function(ev) {               var robot = ev.robot;               robot.fire();               robot.clone();            };            window.robotClass.prototype.onHitByBullet = function(ev) {               var robot = ev.robot;                                          };";
